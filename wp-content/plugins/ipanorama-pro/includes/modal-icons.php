...
<div id="ipanorama-modal-{{ modalData.id }}" class="ipanorama-modal ipanorama-no-max-width" tabindex="-1">
	<div class="ipanorama-modal-dialog">
		<div class="ipanorama-modal-header">
			...
			<div class="ipanorama-modal-title"><i class="xfa fa-info-circle"></i><?php esc_html_e('Select an icon', IPANORAMA_PLUGIN_NAME); ?></div>
		</div>
		...
		<div class="ipanorama-modal-footer">
			<div class="ipanorama-modal-text"><?php esc_html_e('Selected icon:', IPANORAMA_PLUGIN_NAME); ?> <b>{{modalData.selectedIcon}}</b></div>
