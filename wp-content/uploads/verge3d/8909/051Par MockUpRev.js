...
function runCode(app) {
    ...
    const textPlaca = `Utilizada en ejecución de paredes, cielos rasos y revestimientos de muros interiores, en áreas húmedas en todo tipo de construcciones.`;
    ...
    const nameWall = 'Sistema 051 Par';
