...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__078-01ParMockUpRev.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    ...
    const annotationPlacaHumedad = $("#placahum");
    ...
    annotationPlacaHumedad.on("click", () => { openMuroPopup(titlePlacaHumedad, urlPlacaPDFHumedad, imgPlacaHumedad, textPlacaHumedad) });	
    ...
    const nameWall = 'Sistema 078 Par';
