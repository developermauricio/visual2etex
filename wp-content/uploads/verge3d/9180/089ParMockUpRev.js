...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__089ParMockUpRev.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    ...
    const annotationPlacaHumedad = $("#placahumedad");
    ...
    const nameWall = 'Sistema 089 Par';
