 ...
 * Thu Aug 12 2021 20:59:45 GMT-0500 (hora estándar de Colombia)
...
handleAnnot(true, '1', 'suelo_anotation', 'Suelo Genérico', 'suelo');
handleAnnot(true, '2', 'muro_basico_anotation', '', 'muro');
handleAnnot(true, '3', 'fibra_vidrio_anotation', '', 'fibra');
handleAnnot(true, '4', 'acrilico_anotation', '', 'acrilico');

eventHTMLElem('click', 'muro', false, function(event) {
  setHTMLElemStyle('display', 'block', 'contentPopup', true);
});
eventHTMLElem('click', 'closePopup', true, function(event) {
  setHTMLElemStyle('display', 'none', 'contentPopup', true);
});

eventHTMLElem('click', 'fibra', false, function(event) {
  setHTMLElemStyle('display', 'block', 'contentPopupFibra', true);
});
eventHTMLElem('click', 'closePopupFibra', true, function(event) {
  setHTMLElemStyle('display', 'none', 'contentPopupFibra', true);
});

eventHTMLElem('click', 'acrilico', false, function(event) {
  setHTMLElemStyle('display', 'block', 'contentPopupAcrilico', true);
});
eventHTMLElem('click', 'closePopupAcrilico', true, function(event) {
  setHTMLElemStyle('display', 'none', 'contentPopupAcrilico', true);
});
