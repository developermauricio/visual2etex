...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
	<div id="login">
		<h1><a class="logo-admin" href="<?php echo esc_url( $login_header_url ); ?>" style="background-size: contain !important;"><?php echo $login_header_text; ?></a></h1>
	<?php
	/**
...
switch ( $action ) {
	...
	default:
		...
		<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large btn-login-admin" value="<?php esc_attr_e( 'Log In' ); ?>" style="background-color: #ec7137; border-color: #ec7137;" />
				<?php
